...
from diversityFairness import diversityFairnessMetric
...
def redFairness_louvain_partitions(
    ...
    diversityModularity,diversityModularityList, = diversityFairnessMetric(G, partition,G_attribute = node_attributes, resolution=resolution, weight=weight)
    ...
    while improvement:
        ...
        diversityModularity,new_diversityModularityList, = diversityFairnessMetric(G, partition,G_attribute = node_attributes, resolution=resolution, weight=weight) 

        
        sum_redModularityList = sum(redModularityList)
        sum_blueModularityList = sum(blueModularityList)
        
        writer.writerow([iterationNum,mod, fmod, sum_redModularityList, sum_blueModularityList, sum(diversityModularityList)])
